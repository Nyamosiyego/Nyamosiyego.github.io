...
@section('content')
    <div class="permissions">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-900 uppercase font-bold">Edit Permission</h2>
            </div>
            <div class="flex flex-wrap items-center">
                <a href="{{ route('permission.create') }}" class="bg-blue-900 text-white text-sm uppercase py-2 px-4 mr-2 flex items-center rounded">
