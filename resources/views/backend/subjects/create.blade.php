...
@section('content')
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-900 uppercase font-bold">Add New Subject</h2>
            </div>
            <div class="flex flex-wrap items-center">
                <a href="{{ route('subject.index') }}" class="bg-blue-900 text-white text-sm uppercase py-2 px-4 flex items-center rounded">
