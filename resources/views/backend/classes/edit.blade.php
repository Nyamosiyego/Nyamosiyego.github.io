...
@section('content')
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-black uppercase font-bold">Edit Course</h2>
            </div>
            <div class="flex flex-wrap items-center">
                <a href="{{ route('classes.index') }}" class="bg-blue-900 text-white text-sm uppercase py-2 px-4 flex items-center rounded">
        ...
        <div class="table w-full mt-8 bg-white rounded">
            <form action="{{ route('classes.update',$class->id) }}" method="POST" class="w-full max-w-xl px-6 py-12">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3 block text-black font-bold">
                        <div class="relative">
