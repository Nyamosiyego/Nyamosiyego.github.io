<div class="sidebar hidden sm:block w-0 sm:w-1/6 bg-gray-500 h-screen shadow fixed top-0 left-0 bottom-0 z-40 overflow-y-auto">
    <div class="mb-6 mt-20 px-6">
        <a href="{{ route('home') }}" class="flex items-center text-gray-800 py-2 hover:text-blue-800">
        ...
        @role('Admin')
        <a href="{{ route('student.index') }}" class="flex items-center text-gray-800 py-2 hover:text-blue-800">
        ...
        <a href="{{ route('classes.index') }}" class="flex items-center text-gray-800 py-2 hover:text-blue-800">
            ...
            <span class="ml-2 text-sm font-semibold">COURSES</span>
        </a>

        <a href="{{ route('teacher.index') }}" class="flex items-center text-gray-800 py-2 hover:text-blue-800">
        ...
        <a href="{{ route('subject.index') }}" class="flex items-center text-gray-800 py-2 hover:text-blue-800">
        ...
        <a href="{{ route('parents.index') }}" class="flex items-center text-gray-800 py-2 hover:text-blue-800">
        ...
        <a href="{{ route('attendance.index') }}" class="flex items-center text-gray-800 py-2 hover:text-blue-800">
        ...
        <a href="{{ route('assignrole.index') }}" class="flex items-center text-gray-800 py-2 hover:text-blue-800">
        ...
        <a href="{{ route('roles-permissions') }}" class="flex items-center text-gray-800 py-2 hover:text-blue-800">
