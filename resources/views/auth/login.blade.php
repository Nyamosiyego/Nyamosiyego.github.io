...
<div class="w-full max-w-xs mx-auto">
    <form method="POST" action="{{ route('login') }}" class="bg-white shadow rounded px-8 pt-6 pb-8 mb-4">
        @csrf
        <div class="mb-4">
            <label class="block text-gray-800 text-sm font-bold mb-2" for="emailaddress">
                Email Address
            </label>
        ...
        <div class="flex items-center justify-between">
            <button class="bg-red-900 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
                Log In
            </button>
        </div>
    </form>
