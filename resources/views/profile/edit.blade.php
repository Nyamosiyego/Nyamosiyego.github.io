...
@section('content')
    <div class="profile">
        <div class="sm:flex sm:items-center sm:justify-between mb-6">
            <div>
                <h2 class="text-black uppercase font-bold">Profile</h2>
            </div>
            <div class="flex flex-wrap items-center">
                <a href="{{ route('profile') }}" class="bg-gray-700 text-white text-sm uppercase py-2 px-4 flex items-center rounded">
                ...
                <div class="w-full sm:w-auto order-last sm:order-first">
                    <div class="md:flex md:items-center mb-4">
                        ...
                        <div class="md:w-2/3">
                            ...
                            @error('name')
                                <p class="text-red-900 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                    </div>
                    <div class="md:flex md:items-center mb-4">
                    ...
                    <div class="md:flex md:items-center">
                        ...
                        <div class="md:w-2/3">
                            <button class="w-full shadow bg-red-900 hover:bg-blue-800 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit">
                                Submit Changes
                            </button>
                        </div>
                    </div>
