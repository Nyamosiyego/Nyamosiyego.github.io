    ...
    <div class="profile">
        <div class="sm:flex sm:items-center sm:justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('profile.edit') }}" class="bg-blue-800 text-white text-sm uppercase py-2 px-4 flex items-center rounded">
            ...
            <div class="w-full max-w-2xl mx-auto px-6 py-12 flex justify-between">
                <div>
                    ...
                    <div class="md:flex md:items-center mb-4">
                        ...
                        <div class="md:w-2/3">
                            <span class="text-gray-800 font-bold">{{ auth()->user()->roles[0]->name ?? '' }}</span>
                        </div>
                    </div>
                </div>        
                <div>
