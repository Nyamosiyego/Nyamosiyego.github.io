<div class="w-full block mt-8">
    <div class="flex flex-wrap sm:flex-no-wrap justify-between">
        <div class="w-full bg-blue-800 text-center border border-gray-300 px-8 py-6 rounded">
        ...
        <div class="w-full bg-blue-800 text-center border border-gray-300 px-8 py-6 mx-0 sm:mx-6 my-4 sm:my-0 rounded">
            <h3 class="text-white uppercase font-bold">
...
<div class="w-full block mt-8">
    <div class="flex flex-wrap sm:flex-no-wrap justify-between">
        <div class="w-full sm:w-1/2 mr-2 mb-6">
            <h3 class="text-black uppercase font-bold mb-2">Class List</h3>
            <div class="flex flex-wrap items-center">
                @foreach ($teacher->classes as $class)
                    <div class="w-full sm:w-1/2 text-center border border-gray-400 rounded">
                        ...
                        <a href="{{ route('teacher.attendance.create',$class->id) }}" class="bg-red-900 inline-block mb-4 text-xs text-white uppercase font-semibold px-4 py-2 border border-gray-300 rounded">Manage Attendence</a>
                    </div>
                @endforeach
            </div>
        </div>
        <div class="w-full sm:w-1/2 ml-2 mb-6">
            <h3 class="text-black uppercase font-bold mb-2">Subject List</h3>
            <div class="flex items-center bg-red-900 rounded-tl rounded-tr">
